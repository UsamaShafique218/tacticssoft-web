...
function SocialLinks() { 
    return (
        <div className="social_links" data-aos="fade-up">
            ...
            <a href="https://www.linkedin.com/company/tactics-soft" target="_blank" rel="noreferrer" aria-label="LinkedIn">
            ...
            <a href="#" target="_blank"> 
                <svg fill="currentColor" width="800px" height="800px" viewBox="0 0 32 32" id="Camada_1" version="1.1" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                    <g>
